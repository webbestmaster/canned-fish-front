!(function (t, e) {
    ...
    return (function (t) {
        ...
        function r(t, e) {
            (typeof t == 'undefined' ? 'undefined' : o(t)) === 'object' && (e = t, t = void 0), e = e || {}; let n, r = i(t), s = r.source, u = r.id, h = r.path, f = p[u] && h in p[u].nsps, l = e.forceNew || e['force new connection'] || !1 === e.multiplex || f;
        ...
        (function (e) {
            function r(t, n) {
                ...
                n = n || e.location, t == null && (t = n.protocol + '//' + n.host), typeof t == 'string' && (t.charAt(0) === '/' && (t = t.charAt(1) === '/' ? n.protocol + t : n.host + t), /^(https?|wss?):\/\//.test(t) || (i('protocol-less url %s', t), t = typeof n != 'undefined' ? n.protocol + '//' + t : 'https://' + t), i('parse %s', t), r = o(t)), r.port || (/^(http|ws)$/.test(r.protocol) ? r.port = '80' : /^(http|ws)s$/.test(r.protocol) && (r.port = '443')), r.path = r.path || '/'; let s = r.host.indexOf(':') !== -1, a = s ? '[' + r.host + ']' : r.host;
        ...
        let n = /^(?:(?![^:@]+:[^:@\/]*@)(http|https|ws|wss):\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?((?:[a-f0-9]{0,4}:){2,7}[a-f0-9]{0,4}|[^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/, r = ['source', 'protocol', 'authority', 'userInfo', 'user', 'password', 'host', 'port', 'relative', 'path', 'directory', 'file', 'query', 'anchor'];

        t.exports = function (t) {
            let e = t, o = t.indexOf('['), i = t.indexOf(']');
        ...
        (function (r) {
            function o() {
                ...
                t.splice(1, 0, r, 'color: inherit'); let o = 0, i = 0;
            ...
            try {
                t = e.storage.debug;
            } catch (n) {} return !t && typeof r != 'undefined' && 'env' in r && (t = r.env.DEBUG), t;
        } function p() {
            try {
                return window.localStorage;
            } catch (t) {}
        }e = t.exports = n(5), e.log = s, e.formatArgs = i, e.save = a, e.load = c, e.useColors = o, e.storage = typeof chrome != 'undefined' && typeof chrome.storage != 'undefined' ? chrome.storage.local : p(), e.colors = ['lightseagreen', 'forestgreen', 'goldenrod', 'dodgerblue', 'darkorchid', 'crimson'], e.formatters.j = function (t) {
            try {
    ...
    } function p() {} let u, h, f = t.exports = {};
        ...
        function n() {
            if (n.enabled) {
                let t = n, r = Number(new Date()), o = r - (p || r);

                t.diff = o, t.prev = p, t.curr = r, p = r; for (var i = new Array(arguments.length), s = 0; s < i.length; s++) {
                    i[s] = arguments[s];
                }i[0] = e.coerce(i[0]), typeof i[0] != 'string' && i.unshift('%O'); let a = 0;

                i[0] = i[0].replace(/%([a-zA-Z%])/g, function (n, r) {
                    if (n === '%%') {
                        return n;
                    } a++; const o = e.formatters[r];
                ...
                }), e.formatArgs.call(t, i); const c = n.log || e.log || console.log.bind(console);

                c.apply(t, i);
            }
        } return n.namespace = t, n.enabled = e.enabled(t), n.useColors = e.useColors(), n.color = r(t), typeof e.init == 'function' && e.init(n), n;
    } function i(t) {
        e.save(t), e.names = [], e.skips = []; for (let n = (typeof t == 'string' ? t : '').split(/[\s,]+/), r = n.length, o = 0; o < r; o++) {
    ...
    }e = t.exports = o.debug = o.default = o, e.coerce = c, e.disable = s, e.enable = i, e.enabled = a, e.humanize = n(6), e.names = [], e.skips = [], e.formatters = {}; let p;
    }, function (t, e) {
        function n(t) {
        if (t = String(t), !(t.length > 100)) {
            ...
            if (e) {
                let n = parseFloat(e[1]), r = (e[2] || 'ms').toLowerCase();
    ...
    function r() {} function o(t) {
        ...
        return e.BINARY_EVENT !== t.type && e.BINARY_ACK !== t.type || (n += t.attachments + '-'), t.nsp && t.nsp !== '/' && (n += t.nsp + ','), t.id != null && (n += t.id), t.data != null && (n += JSON.stringify(t.data)), h('encoded %j as %s', t, n), n;
    } function i(t, e) {
        function n(t) {
            let n = d.deconstructPacket(t), r = o(n.packet), i = n.buffers;
    ...
    e.protocol = 4, e.types = ['CONNECT', 'DISCONNECT', 'EVENT', 'ACK', 'ERROR', 'BINARY_EVENT', 'BINARY_ACK'], e.CONNECT = 0, e.DISCONNECT = 1, e.EVENT = 2, e.ACK = 3, e.ERROR = 4, e.BINARY_EVENT = 5, e.BINARY_ACK = 6, e.Encoder = r, e.Decoder = s, r.prototype.encode = function (t, n) {
        ...
        if (typeof t == 'string') {
            n = a(t), e.BINARY_EVENT === n.type || e.BINARY_ACK === n.type ? (this.reconstructor = new p(n), this.reconstructor.reconPack.attachments === 0 && this.emit('decoded', n)) : this.emit('decoded', n);
        } else {
            if (!y(t) && !t.base64) {
    ...
    function r(t) {
        ...
        this._callbacks = this._callbacks || {}; let e = [].slice.call(arguments, 1), n = this._callbacks['$' + t];
    ...
    (function (e) {
        function r(t) {
            ...
            } if (typeof e.Buffer == 'function' && e.Buffer.isBuffer && e.Buffer.isBuffer(t) || typeof e.ArrayBuffer == 'function' && t instanceof ArrayBuffer || s && t instanceof Blob || a && t instanceof File) {
                return !0;
        ...
        } var o = n(10), i = Object.prototype.toString, s = typeof e.Blob == 'function' || i.call(e.Blob) === '[object BlobConstructor]', a = typeof e.File == 'function' || i.call(e.File) === '[object FileConstructor]';
    ...
    (function (t) {
        ...
        } var i = n(10), s = n(12), a = Object.prototype.toString, c = typeof t.Blob == 'function' || a.call(t.Blob) === '[object BlobConstructor]', p = typeof t.File == 'function' || a.call(t.File) === '[object FileConstructor]';
    ...
    if (h('readyState %s', this.readyState), ~this.readyState.indexOf('open')) {
        return this;
    } h('opening %s', this.uri), this.engine = i(this.uri, this.opts); let n = this.engine, r = this;

    this.readyState = 'opening', this.skipReconnect = !1; let o = p(n, 'open', function () {
            r.onopen(), t && t();
    ...
    t.query && t.type === 0 && (t.nsp += '?' + t.query), e.encoding ? e.packetBuffer.push(t) : (e.encoding = !0, this.encoder.encode(t, function (n) {
    ...
    if (this.backoff.attempts >= this._reconnectionAttempts) {
        ...
        h('will wait %dms before reconnect attempt', e), this.reconnecting = !0; const n = setTimeout(function () {
    ...
    (function (e) {
            ...
            function e() {
                ...
                if (e.type === 'pong' && e.data === 'probe') {
                    if (a('probe transport "%s" pong', t), f.upgrading = !0, f.emit('upgrading', u), !u) {
                        return;
                    } r.priorWebsocketSuccess = u.name === 'websocket', a('pausing current transport "%s"', f.transport.name), f.transport.pause(function () {
        ...
        u.removeListener('open', e), u.removeListener('error', o), u.removeListener('close', i), f.removeListener('close', s), f.removeListener('upgrading', c);
    }a('probing transport "%s"', t); var u = this.createTransport(t, {probe: 1}), h = !1, f = this;
            ...
            case 'open':this.onHandshake(h(t.data)); break; case 'pong':this.setPing(), this.emit('pong'); break; case 'error':var e = new Error('server error');
    ...
    if (typeof e == 'function' && (r = e, e = void 0), typeof n == 'function' && (r = n, n = null), this.readyState !== 'closing' && this.readyState !== 'closed') {
        n = n || {}, n.compress = !1 !== n.compress; const o = {type: t, data: e, options: n};
    ...
    (function (t) {
        function r(e) {
            let n, r = !1, a = !1, c = !1 !== e.jsonp;

            if (t.location) {
                let p = location.protocol === 'https:', u = location.port;
    ...
    (function (e) {
        ...
        t.exports = function (t) {
            let n = t.xdomain, o = t.xscheme, i = t.enablesXDR;
    ...
    (function (e) {
        function r() {} function o(t) {
            if (c.call(this, t), this.requestTimeout = t.requestTimeout, this.extraHeaders = t.extraHeaders, e.location) {
                let n = location.protocol === 'https:', r = location.port;
        ...
        t.exports = o, t.exports.Request = i, u(o, c), o.prototype.supportsBinary = !0, o.prototype.request = function (t) {
            ...
            let n = typeof t != 'string' && void 0 !== t, r = this.request({method: 'POST', data: t, isBinary: n}), o = this;

            r.on('success', e), r.on('error', function (t) {
                o.onError('xhr post error', t);
            }), this.sendXhr = r;
        }, o.prototype.doPoll = function () {
            h('xhr poll'); let t = this.request(), e = this;
            ...
            const t = {agent: this.agent, xdomain: this.xd, xscheme: this.xs, enablesXDR: this.enablesXDR};

            t.pfx = this.pfx, t.key = this.key, t.passphrase = this.passphrase, t.cert = this.cert, t.ca = this.ca, t.ciphers = this.ciphers, t.rejectUnauthorized = this.rejectUnauthorized; let n = this.xhr = new a(t), r = this;

            try {
                h('xhr open %s: %s', this.method, this.uri), n.open(this.method, this.uri, this.async); try {
                    if (this.extraHeaders) {
                        n.setDisableHeaderCheck && n.setDisableHeaderCheck(!0); for (const o in this.extraHeaders) {
                    this.extraHeaders.hasOwnProperty(o) && n.setRequestHeader(o, this.extraHeaders[o]);
                }
                    }
                } catch (s) {} if (this.method === 'POST') {
                    try {
            ...
            } catch (e) {}t === 'application/octet-stream' && (n.responseType = 'arraybuffer');
    ...
    a(r, o), r.prototype.name = 'polling', r.prototype.doOpen = function () {
        ...
        let t = this.query || {}, e = this.secure ? 'https' : 'http', n = '';
    ...
    (function (t) {
        function r(t, n) {
            ...
            } let o = t.data, i = new Uint8Array(o), s = new Uint8Array(1 + o.byteLength);
            ...
            o[0] = v[t.type]; const s = new k([o.buffer, t.data]);
        ...
        t && t.ArrayBuffer && (p = n(29)); var y = typeof navigator != 'undefined' && /Android/i.test(navigator.userAgent), m = typeof navigator != 'undefined' && /PhantomJS/i.test(navigator.userAgent), g = y || m;

        e.protocol = 3; var v = e.packets = {open: 0, close: 1, ping: 2, pong: 3, message: 4, upgrade: 5, noop: 6}, b = u(v), w = {type: 'error', data: 'parser error'}, k = n(30);

        e.encodePacket = function (e, n, i, a) {
            typeof n == 'function' && (a = n, n = !1), typeof i == 'function' && (a = i, i = null); const c = void 0 === e.data ? void 0 : e.data.buffer || e.data;
            ...
            return void 0 !== e.data && (p += i ? d.encode(String(e.data), {strict: !1}) : String(e.data)), a(String(p));
            ...
            return k && n === 'blob' && (s = new k([s])), {type: b[o], data: s};
            ...
            function o(t) {
                ...
                e.encodePacket(t, Boolean(s) && n, !1, function (t) {
                r(null, o(t));
            });
    ...
    t.exports = Object.keys || function (t) {
        let e = [], n = Object.prototype.hasOwnProperty;
    ...
    (function (t, o) {
        !(function (i) {
            function s(t) {
                ...
                return (4294965248 & t) == 0 ? n = w(t >> 6 & 31 | 192) : (4294901760 & t) == 0 ? (c(t, e) || (t = 65533), n = w(t >> 12 & 15 | 224), n += p(t, 6)) : (4292870144 & t) == 0 && (n = w(t >> 18 & 7 | 240), n += p(t, 12), n += p(t, 6)), n += w(63 & t | 128);
            } function h(t, e) {
    ...
    } if ((248 & e) == 240 && (n = f(), r = f(), o = f(), i = (7 & e) << 18 | n << 12 | r << 6 | o, i >= 65536 && i <= 1114111)) {
        return i;
    } throw Error('Invalid UTF-8 detected');
} function d(t, e) {
    e = e || {}; const n = !1 !== e.strict;

    g = s(t), v = g.length, b = 0; for (var r, o = []; (r = l(n)) !== !1;) {
        o.push(r);
    } return a(o);
} let y = typeof e == 'object' && e, m = (typeof t == 'object' && t && t.exports == y && t, typeof o == 'object' && o);

            m.global !== m && m.window !== m || (i = m); var g, v, b, w = String.fromCharCode, k = {version: '2.1.2', encode: h, decode: d};
    ...
    !(function () {
        for (var t = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/', n = new Uint8Array(256), r = 0; r < t.length; r++) {
            ...
            let n, r = new Uint8Array(e), o = r.length, i = '';

            for (n = 0; n < o; n += 3) {
                i += t[r[n] >> 2], i += t[(3 & r[n]) << 4 | r[n + 1] >> 4], i += t[(15 & r[n + 1]) << 2 | r[n + 2] >> 6], i += t[63 & r[n + 2]];
            } return o % 3 === 2 ? i = i.substring(0, i.length - 1) + '=' : o % 3 === 1 && (i = i.substring(0, i.length - 2) + '=='), i;
        }, e.decode = function (t) {
            let e, r, o, i, s, a = 0.75 * t.length, c = t.length, p = 0;

            t[t.length - 1] === '=' && (a--, t[t.length - 2] === '=' && a--); let u = new ArrayBuffer(a), h = new Uint8Array(u);
    ...
    (function (e) {
        function r() {} function o(t) {
            i.call(this, t), this.query = this.query || {}, a || (e.___eio || (e.___eio = []), a = e.___eio), this.index = a.length; const n = this;
        ...
        s(o, i), o.prototype.supportsBinary = !1, o.prototype.doClose = function () {
            ...
            let t = this, e = document.createElement('script');
    ...
    (function (e) {
        ...
        l || typeof window != 'undefined' || (l = o), t.exports = r, c(r, i), r.prototype.name = 'websocket', r.prototype.supportsBinary = !0, r.prototype.doOpen = function () {
            if (this.check()) {
                let t = this.uri(), e = this.protocols, n = {agent: this.agent, perMessageDeflate: this.perMessageDeflate};
            ...
            this.writable = !1; for (var o = t.length, i = 0, a = o; i < a; i++) {
                !(function (t) {
                    s.encodePacket(t, r.supportsBinary, function (i) {
                        if (!r.usingBrowserWebSocket) {
                            ...
                            let a = typeof i == 'string' ? e.Buffer.byteLength(i) : i.length;
            ...
            let t = this.query || {}, e = this.secure ? 'wss' : 'ws', n = '';

            this.port && (e === 'wss' && Number(this.port) !== 443 || e === 'ws' && Number(this.port) !== 80) && (n = ':' + this.port), this.timestampRequests && (t[this.timestampParam] = p()), this.supportsBinary || (t.b64 = 1), t = a.encode(t), t.length && (t = '?' + t); const r = this.hostname.indexOf(':') !== -1;
    ...
    (function (e) {
        let n = /^[\],:{}\s]*$/, r = /\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g, o = /"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g, i = /(?:^|:|,)(?:\s*\[)+/g, s = /^\s+/, a = /\s+$/;

        t.exports = function (t) {
            return typeof t == 'string' && t ? (t = t.replace(s, '').replace(a, ''), e.JSON && JSON.parse ? JSON.parse(t) : n.test(t.replace(r, '@').replace(o, ']').replace(i, '')) ? new Function('return ' + t)() : void 0) : null;
        };
    }).call(e, (function () {
        return this;
    })());
    ...
    } let o = typeof Symbol == 'function' && typeof Symbol.iterator == 'symbol' ? function (t) {
            return typeof t;
        } : function (t) {
            return t && typeof Symbol == 'function' && t.constructor === Symbol && t !== Symbol.prototype ? 'symbol' : typeof t;
        }, i = n(7), s = n(8), a = n(40), c = n(41), p = n(42), u = n(3)('socket.io-client:socket'), h = n(31);

    t.exports = e = r; let f = {connect: 1, connect_error: 1, connect_timeout: 1, connecting: 1, disconnect: 1, error: 1, reconnect: 1, reconnect_attempt: 1, reconnect_failed: 1, reconnect_error: 1, reconnecting: 1, ping: 1, pong: 1}, l = s.prototype.emit;
    ...
    s(r.prototype), r.prototype.subEvents = function () {
        ...
        } let e = a(arguments), n = {type: i.EVENT, data: e};

        return n.options = {}, n.options.compress = !this.flags || !1 !== this.flags.compress, typeof e[e.length - 1] == 'function' && (u('emitting packet with ack id %d', this.ids), this.acks[this.ids] = e.pop(), n.id = this.ids++), this.connected ? this.packet(n) : this.sendBuffer.push(n), delete this.flags, this;
    }, r.prototype.packet = function (t) {
    ...
    function n(t) {
        ...
        if (this.jitter) {
            let e = Math.random(), n = Math.floor(e * this.jitter * t);
